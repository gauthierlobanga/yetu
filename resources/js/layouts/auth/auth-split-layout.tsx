        ...
        <div className="grid min-h-svh bg-background lg:grid-cols-2">
            ...
            <div className="relative flex items-center justify-center px-6 py-10 md:px-10">
                ...
                <div className="pointer-events-none absolute inset-0">
                    ...
                    {/* Gradient radial */}
                    <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(16,185,129,0.06),transparent_40%)] dark:bg-[radial-gradient(circle_at_top,rgba(16,185,129,0.04),transparent_45%)]" />

                    {/* Fine grid overlay */}
                    <div className="absolute inset-0 bg-[linear-gradient(to_right,rgba(148,163,184,0.04)_1px,transparent_1px),linear-gradient(to_bottom,rgba(148,163,184,0.04)_1px,transparent_1px)] bg-[size:36px_36px]" />
                </div>
                ...
                >
                    ...
                    <div className="relative overflow-hidden rounded-3xl border border-white/70 bg-white/85 shadow-2xl shadow-slate-900/8 backdrop-blur-2xl dark:border-white/10 dark:bg-slate-900/85 dark:shadow-black/30">
                        ...
                        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(255,255,255,0.6),transparent_45%)] dark:bg-[radial-gradient(circle_at_top,rgba(255,255,255,0.04),transparent_45%)]" />
