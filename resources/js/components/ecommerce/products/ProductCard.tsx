...
//     // Formatage du nombre de ventes (ex: 10000+ → 10k+)
...
//     // Génération des étoiles (5 étoiles fixes, remplies selon la note)
//     const renderStars = () => {
...
//                     {/* Badge promo supplémentaire (si présent) */}
