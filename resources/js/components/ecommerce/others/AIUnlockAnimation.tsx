...
export function AIUnlockAnimation({ autoPlay = true }: AIUnlockAnimationProps) {
    ...
    return (
        <div className="relative w-full max-w-md">
            {/* Main content card */}
            <motion.div
                className="relative rounded-2xl border border-border bg-card p-16 shadow-sm"
                animate={
                    isUnlocking
                        ? {
                              boxShadow: [
            ...
            >
                    ...
                    {isUnlocking && (
                        <>
                            {[0, 0.2, 0.4].map((delay, i) => (
                                <motion.div
                                    key={i}
                                    className="absolute inset-0 z-0 rounded-2xl border border-foreground"
                ...
                <div className="relative z-10 flex flex-col items-center space-y-8">
                    ...
                    >
                        ...
                        <motion.div
                            className="relative flex h-20 w-20 items-center justify-center rounded-full border-2 border-foreground bg-card"
                            animate={
                                isUnlocking
                                    ? {
                                          borderColor: [
                    ...
                    <div className="space-y-4 text-center">
                        ...
                        {isUnlocking && !isComplete && (
                            <motion.div
                                className="h-px w-48 overflow-hidden bg-border"
                                initial={{ opacity: 0 }}
                                animate={{ opacity: 1 }}
                            >
                                <motion.div
                    ...
                    {isUnlocking && (
                        <>
                            {[
                                ...
                                <motion.div
                                    key={corner}
                                    className={`absolute h-8 w-8 border-foreground ${
                                        corner === 'top-left'
