...
//     // 🔥 CORRECTION: Utiliser useRef pour le timeout et éviter les dépendances problématiques
...
//     // 🔥 CORRECTION: Debounce search avec useCallback et nettoyage
...
//     // 🔥 CORRECTION: useEffect avec dépendances minimales
//     useEffect(() => {
//         // Ne pas déclencher si searchTerm est identique à filters.search
...
//     // Synchroniser searchTerm avec filters.search (venant de l'extérieur)
//     useEffect(() => {
...
//     // 🔥 CORRECTION: Mémoïser les handlers pour éviter les re-rendus inutiles
...
//             filters.status ||
//             filters.category_id ||
//             (filters.sort && filters.sort !== 'published_at') // Ignorer le tri par défaut
//         );
//     }, [filters]);
...
//         if (filters.sort && filters.sort !== 'published_at') count++;
//         return count;
//     }, [filters]);

//     const getSortValue = useCallback(() => {
//         if (filters.sort) {
//             return `${filters.sort}:${filters.direction || 'desc'}`;
//         }
...
//     // 🔥 CORRECTION: Handler pour effacer un filtre spécifique
...
//             {/* 🔥 CORRECTION: Condition pour afficher les filtres actifs */}
//             {hasActiveFilters && (
