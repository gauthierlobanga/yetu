...
export function PhotonBeam(props: PhotonBeamProps = {}) {
    ...
    useEffect(() => {
        ...
        const init = (): void => {
            ...
            function getPathPoint(
                ...
                if (currentX < 0) {
                    const ratio =
                        (currentX + params.curveLength) / params.curveLength;
            ...
            function pickSignalColor(): THREE.Color {
                ...
                if (params.useColor2) {
                    choices.push(signalColorObj2);
                }

                if (params.useColor3) {
                    choices.push(signalColorObj3);
                }
            ...
            // Resize Handler
            handleResize = (): void => {
                if (!container || cancelled || !renderer || !composer) {
                    return;
                }
    ...
    return (
        <div ref={containerRef} className="h-full min-h-50 w-full bg-black" />
    );
}
