            ...
            {hits.map((hit: any, idx: number) => {
                ...
                return (
                    <a
                        ...
                        className="text-decoration-none flex cursor-pointer flex-row items-center gap-3 rounded-sm bg-background p-3 text-foreground transition-colors aria-selected:bg-accent"
                        role="option"
                        aria-selected={isSel}
                        onMouseEnter={() => {
                            if (!hoverEnabled) {
                    ...
                    >
                        {hasImage ? (
                            <div className="h-12 w-12 flex-[0_0_48px] items-center justify-center self-start overflow-hidden rounded-sm bg-muted">
                                {!isImageFailed ? (
                                    <img
                        ...
                        <div className="min-w-0 flex-1">
                            <p className="truncate text-sm font-medium [&_mark]:bg-transparent [&_mark]:font-semibold [&_mark]:text-primary">
                                <Highlight
                                    attribute={
                                        toAttributePath(
                                            mapping.primaryText,
                            ...
                            {mapping.secondaryText ? (
                                <p className="mt-1 line-clamp-1 text-xs text-muted-foreground [&_mark]:bg-transparent [&_mark]:font-medium [&_mark]:text-foreground">
                                    <Highlight
                                        attribute={
                                            toAttributePath(
                                                mapping.secondaryText,
    ...
    return (
        <>
            ...
            <Popover.Root open={open} onOpenChange={setOpen}>
                ...
                <Popover.Portal>
                    <Popover.Content
                        className="z-50 mt-1 w-(--radix-popover-trigger-width) rounded-md border bg-popover p-1 text-popover-foreground shadow-md data-[side=bottom]:slide-in-from-top-2 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 data-[state=open]:animate-in data-[state=open]:fade-in-0 data-[state=open]:zoom-in-95"
                        side="bottom"
                        align="start"
                        sideOffset={4}
                        onOpenAutoFocus={(e) => {
                    ...
                    >
                        ...
                        <div className="border-text-muted-foreground border-t px-2 py-1 text-right text-xs text-muted-foreground">
                            Powered by Algolia
                        </div>
                    </Popover.Content>
                </Popover.Portal>
