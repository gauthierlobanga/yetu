...
//         >
//             {/* Background premium */}
//             <div className="absolute inset-0 bg-linear-to-br from-orange-50 via-white to-yellow-50 dark:from-orange-950/20 dark:to-yellow-950/20" />

//             {/* Glow effects */}
//             <div className="absolute -top-40 -left-40 h-96 w-96 rounded-full bg-orange-400/20 blur-3xl" />
//             <div className="absolute -right-40 -bottom-40 h-96 w-96 rounded-full bg-red-400/20 blur-3xl" />
...
//                             <span className="block bg-linear-to-r from-orange-500 to-red-500 bg-clip-text text-transparent">
//                                 collection Premium
//                             </span>
//                         </h1>
...
//                                     {/* Glow hover */}
//                                     <span className="absolute inset-0 bg-linear-to-r from-orange-500 to-red-500 opacity-0 transition group-hover:opacity-100" />
//                                 </Link>
//                             </Button>
...
//                             {/* Glow */}
//                             <div className="absolute inset-0 rounded-3xl bg-linear-to-br from-orange-500/30 to-red-500/30 blur-2xl" />
