...
const ReadingProgressBar = () => {
    ...
    return (
        <div className="fixed top-0 right-0 left-0 z-50 h-0.5 bg-slate-200 dark:bg-slate-800">
            <div
                className="h-full bg-gradient-to-r from-emerald-400 to-emerald-600 shadow-sm transition-all duration-150"
...
export default function Show({
    ...
    return (
        <MainLayout breadcrumbs={breadcrumbs}>
            ...
            <article className="min-h-screen bg-gradient-to-b from-white via-emerald-50/30 to-slate-50/50 dark:from-slate-950 dark:via-emerald-950/10 dark:to-slate-950">
                {/* Hero section avec fond émeraude léger */}
                <div className="relative overflow-hidden border-b border-emerald-100 bg-gradient-to-br from-white via-emerald-50/50 to-slate-50 dark:border-emerald-900/30 dark:from-slate-950 dark:via-emerald-950/20 dark:to-slate-950">
                ...
                {relatedPosts && relatedPosts.length > 0 && (
                    <div className="border-t border-slate-100 bg-gradient-to-b from-slate-50/50 to-white dark:border-slate-800 dark:from-slate-950/50 dark:to-slate-950">
                ...
                <div className="border-t border-slate-100 dark:border-slate-800">
                    <div className="container mx-auto max-w-6xl px-4 py-12">
                        ...
                        <div className="rounded-2xl border border-slate-200 bg-white p-8 text-center dark:border-slate-800 dark:bg-slate-900/60">
                            ...
                            <Link
                                href="/login"
                                className="inline-flex items-center justify-center rounded-xl bg-gradient-to-r from-emerald-600 to-emerald-500 px-6 py-2.5 font-medium text-white shadow-md shadow-emerald-500/20 transition-all hover:from-emerald-700 hover:to-emerald-600"
                            >
                                Se connecter
                            </Link>
                        </div>
