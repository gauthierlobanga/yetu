...
export default function ShopWishlistPage() {
    ...
    return (
        <ShopAccountShell
            headTitle="Wishlist"
            title={wishlist.nom}
            description="Retrouvez vos coups de cœur, comparez vos favoris et ajoutez-les au panier en un clic."
            active="wishlist"
            stats={[
                {
                    label: 'Articles',
        ...
        >
            ...
            <div
                className={cn(
                    'relative mb-8 overflow-hidden rounded-3xl border',
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">
                                Gardez vos produits préférés à portée de main et
                                ajoutez-les au panier au bon moment.
                            </p>
                        </div>
                    </div>
                ...
                {items.length > 0 ? (
                                ...
                                >
                                    ...
                                    <button
                                        ...
                                        className={cn(
                                            ...
                                            'hover:scale-105 hover:bg-red-50 hover:text-red-600',
                    ...
                    >
                        ...
                        <p className="mt-3 max-w-md text-sm leading-6 text-slate-500 dark:text-slate-400">
                            Ajoutez vos produits préférés à votre liste de
                            souhaits pour les retrouver rapidement et les
                            acheter au meilleur moment.
                        </p>
