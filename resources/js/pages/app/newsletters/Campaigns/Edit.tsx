                    ...
                    <div className="mx-auto max-w-5xl px-4 py-10 sm:px-6 lg:px-8">
                        ...
                        {campaign.status === 'envoye' && (
                            <div className="mb-6 rounded-md border border-amber-200 bg-amber-50 p-4 text-sm text-amber-800">
                                Cette campagne a déjà été envoyée et ne peut
                                plus être modifiée.
                            </div>
                        )}
                            ...
                            <div className="grid gap-6 md:grid-cols-3">
                                ...
                                <div className="space-y-6">
                                    <Card className="border-slate-200 dark:border-slate-800">
                                        ...
                                        <CardFooter className="flex justify-end border-t border-slate-200 bg-slate-50 p-4 dark:border-slate-800 dark:bg-slate-900/50">
                                            <Button
                                                type="submit"
                                                disabled={
                                                    processing ||
