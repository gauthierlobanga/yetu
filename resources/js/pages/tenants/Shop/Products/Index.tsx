...
import FiltersPanel from '@/components/tenants/shop/products/FiltersPanel';
...
import type { PageProps, Product, Category } from '@/types/tenants/products';
...
export default function ProductsIndex() {
    ...
    const handleImageUpload = async (
        ...
        try {
            ...
            const response = await fetch(route('tenant.search.by-image'), {
                method: 'POST',
                body: formData,
                headers: {
