    ...
    return (
        ...
        >
            ...
            <SidebarInset>
                ...
                <div
                    ref={containerRef}
                    className="relative min-h-screen overflow-hidden dark:bg-slate-950"
                >
                    ...
                    <div className="relative z-10 mx-auto max-w-425 px-4 py-8 sm:px-6 lg:px-8">
                        ...
                        <div className="flex flex-col gap-8">
                            {/* Revenue + Status : deux colonnes sur desktop, une sur mobile */}
                            ...
                            {/* Produits les plus vendus (pleine largeur) */}
                            <motion.div
                                initial="hidden"
                                whileInView="visible"
                                viewport={{ once: true }}
                            ...
                            <div className="grid gap-8 xl:grid-cols-2">
                                ...
                                <div>
                                    {stockData && stockData.length > 0 ? (
                                        ...
                                        <div className="flex h-full flex-col items-center justify-center rounded-2xl border border-dashed border-slate-200 p-10 text-center dark:border-slate-700">
                            ...
                            {/* Fret + Satisfaction – deux colonnes */}
                            <div className="grid gap-6 md:grid-cols-2">
                                ...
                                <div>
                                    {freightData && freightData.length > 0 ? (
                                        ...
                                        <div className="flex h-full flex-col items-center justify-center rounded-2xl border border-dashed border-slate-200 p-6 text-center dark:border-slate-700">
                                            <Truck className="mx-auto h-8 w-8 text-slate-400" />
                                            <p className="mt-2 text-sm text-slate-500">
                                                Aucune donnée de fret
                                            </p>
                                        </div>
                                    )}
                                </div>
                        ...
                        {/* TABLES ANALYTIQUES PREMIUM – empilées verticalement */}
                        <motion.section
                            initial="hidden"
                            whileInView="visible"
                            viewport={{ once: true }}
                        ...
                        >
                            ...
                            {/* Empilement vertical : Commandes puis Paiements */}
                            <div className="flex flex-col gap-8">
                                {/* Dernières commandes */}
                                <motion.div
                                    variants={cardVariants}
