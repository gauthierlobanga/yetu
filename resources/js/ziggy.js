const Ziggy = {
    ...
    routes: {
        ...
        'default-livewire.update': {
            uri: 'livewire-6bdc2ece\/update',
            methods: ['POST'],
        },
        'livewire.upload-file': {
            uri: 'livewire-6bdc2ece\/upload-file',
            methods: ['POST'],
        },
        'livewire.preview-file': {
            uri: 'livewire-6bdc2ece\/preview-file\/{filename}',
            methods: ['GET', 'HEAD'],
            parameters: ['filename'],
        },
        home: { uri: '\/', methods: ['GET', 'HEAD'] },
        'tasks.list': { uri: 'tasks', methods: ['GET', 'HEAD'] },
        ...
        'post.list': { uri: 'post', methods: ['GET', 'HEAD'] },
