...
namespace App\Filament\Vendeur\Resources\Categories\Tables;
...
class CategoriesTable
{
    ...
    {
        return $table
            ->modifyQueryUsing(fn (Builder $query) => $query->with('parent.parent.parent.parent'))
            ->columns([
            ...
            ->recordActions([
                ActionGroup::make([
                    ...
                    Action::make('view_posts')
                        ...
                        // ->url(fn ($record) => route('filament.admin.resources.posts.index', ['tableFilters[categories][values][0]' => $record->id]))
                        ->color('info'),
