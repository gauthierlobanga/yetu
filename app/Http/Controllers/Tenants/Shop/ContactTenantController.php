...
class ContactTenantController extends Controller
{
    public function index(): Response
    {
        return Inertia::render('tenants/main/contact/Contact', $this->getPageProps());
    }
    ...
    public function store(StoreContactRequest $request): RedirectResponse
    {
        ...
        return to_route('tenant.contact.index')->with('success', 'Votre message a bien ete envoye. Notre equipe vous recontactera tres vite.');
    }
