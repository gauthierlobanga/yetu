...
class AccountDashboardController extends Controller
{
    public function AccountDashboardIndex(): Response
    {
        ...
        |--------------------------------------------------------------------------
        */
        $commandesQuery = $client->commandes();
        ...
        */
        ...
        |--------------------------------------------------------------------------
        */
        $validOrdersQuery = $client->commandes()
            ->where('statut', '!=', 'annulee');

        $totalSpent = (float) $validOrdersQuery->sum('total');
        ...
        */
        ...
        $completedOrders = $client->commandes()
        ...
        */
        ...
        |
        | IMPORTANT :
        | produits.category_id N'EXISTE PAS
        | relation many-to-many via produit_categorie_pivot
        |--------------------------------------------------------------------------
        */
        $topCategories = DB::table('ligne_commandes')
            ...
            ->join(
                ...
                'produits.id',
                '=',
                'produit_categorie_pivot.produit_id'
            )
            ->join(
                'produit_categories',
                'produit_categorie_pivot.category_id',
                '=',
